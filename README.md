...
As a Data Analyst, I was tasked with using MySQL to analyze current inventory and sales data to determine:
...
* **Data Modeling:** Reverse engineering the database schema to visualize relationships.
